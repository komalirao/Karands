...
function Profileviewnew() {
    ...
    <div  class="row">
        ...
        <div class="d-inline-flex position-relative" >
                    ...
                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" class=" avatar-xl img-thumbnail" alt="profile-image"  />
...
<h5 class="mb-4 text-uppercase d-flex justify-content-start"><i class="mdi mdi-account"></i>
                    ...
                    <p class="text-muted flex text-start pl-2  ">Sravana</p></h6>
                  </div>
                  <div class="col-6" >
                    <h6 class=" d-flex text-start fs-13 fw-normal ">Last Name :
                    <p class="text-muted flex text-start pl-2 ">Bommidi</p></h6>
                  </div>
                  <div class="col-6  ">
                  ...
                  <div class="col-6 ">
                    ...
                    <p class="text-muted flex text-start pl-2 ">sravana@gmail.com0</p></h6>
                  </div>
                  <div class="col-6 ">
                  ...
                  <div class="col-6 ">
                    ...
                    <p class="text-muted flex text-start pl-2 ">Jan 21st 1997</p></h6>
                  </div>
                  <div class="col-6 ">
                    <h6 class=" d-flex text-start fs-13 fw-normal ">Gender :
                    <p class="text-muted flex text-start pl-2 ">Fenale</p></h6>
                  </div>
                  <div class="col-6 ">
                    <h6 class=" d-flex text-start fs-13 fw-normal ">Location :
                    <p class="text-muted flex text-start pl-2  ">Hyd</p></h6>
                  </div>
                  <div class="col-6 ">
                    <h6 class=" d-flex text-start fs-13 fw-normal ">Mobile Number :
                    <p class="text-muted flex text-start pl-2 ">234-2452-262</p></h6>
                  </div>
                  </div>
