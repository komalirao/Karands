...
//import { mentorApi } from "../../../services/UserService";
...
export default function Mentoring() {
  ...
  const takeLocation = (event) => {
    console.log(mentor);
    setMentor((prevstate) => ({ ...prevstate, location: event.target.value }));
  };
  ...
  const takeProfession = (event) => {
    setMentor((prevstate) => ({
      ...prevstate,
      professionalexp: event.target.value,
    }));
  };
  const takeIndustry = (event) => {
    setMentor((prevstate) => ({ ...prevstate, industry: event.target.value }));
  };
  ...
  const takeSkill = (event) => {
    setMentor((prevstate) => ({ ...prevstate, skills: event.target.value }));
  };
  const takeAbout = (event) => {
    setMentor((prevstate) => ({ ...prevstate, about: event.target.value }));
  };
