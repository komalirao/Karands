    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3 row">
                    <label for="staticIndustry" class="col-md-3 col-form-label text-dark">
                      Industry
                    </label>
                    <div class="col-sm-9">
                      <input
                  ...
                  <div class="mb-3 row">
                    <label for="functionalArea" class="col-sm-3 col-form-label text-dark">
                      Functional Area
                    </label>
                    <div class="col-sm-9">
                      <input
                  ...
                  <div class="mb-3 row">
                    <label for="inputLocation" class="col-sm-3 col-form-label text-dark">
                      Location
                    </label>
                    <div class="col-sm-9">
                      <input
                  ...
                  <div class="mb-3 row">
                    <label for="inputSkills" class="col-sm-3 col-form-label text-dark">
                      Skills
                    </label>
                    <div class="col-sm-9">
                      <input
                  ...
                  <div class="mb-3 row">
                    <label for="employmentType" class="col-sm-3 col-form-label text-dark">
                      Employemnt Type
                    </label>
                    <div class="col-sm-9">
                      <input
                  ...
                  <div class="mb-3 row">
                    <label for="inputSalary" class="col-sm-3 col-form-label text-dark">
                      Salary
                    </label>
                    <div class="col-sm-9">
                      <div class="row">
                  ...
                  <div class="mb-3 row">
                    <label for="workExperience" class="col-sm-3 col-form-label text-dark">
                      Work Experience
                    </label>
                    <div class="col-sm-9">
                      <div class="row">
                  ...
                  <div class="mb-3 row">
                    <label for="companyDetails" class="col-sm-3 col-form-label text-dark">
                      Company Name
                    </label>
                    <div class="col-sm-4">
                      <input
          ...
          {/* <button type="button" className="btn btn-primary" data-bs-toggle="modalone" data-bs-target="#exampleModal1">
                        Post Job
                    </button> */}
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={Myjob}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
            ...
            >
              ...
              <ListItemText primary="My job" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          {/* <ListItem disablePadding sx={{ display: 'block' }} onClick={openlist}>
                        ...
                        >
                            ...
                            <ListItemText primary='Lists'  sx={{ opacity: open ? 1 : 0 }} 
                            />
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={openfeed}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={openjob}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
            ...
            >
              ...
              <ListItemText primary="Post Job" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
