            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Search sx={{ backgroundColor: 'white', }}>
                        <SearchIconWrapper sx={{ color: 'blue' }}>
                            <SearchIcon />
                        </SearchIconWrapper>
                        <StyledInputBase
                            placeholder="Search…"
                    ...
                    <Box>
                        <Button variant="text" sx={{ background: 'white', color: 'black', marginLeft: 50 }} onClick=''>Post Feed</Button>
                    </Box>
          ...
          >
            <AccountCircleIcon sx={{ fontSize: 30, color: 'black' ,marginLeft : 140}} />
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex', justifyContent: 'space-between' } }}>
                        <IconButton size="large" aria-label="show new mails" color="inherit">
                            ...
                            {/* <Box>
                                <Button variant="outlined" sx={{ backgroundColor: 'blue', color: 'white', }} onClick=''>Post Feed</Button>
                            </Box> */}
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={dashboard}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={viewprofile}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={EditProfile}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
